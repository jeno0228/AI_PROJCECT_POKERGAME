...
filename = 'C:/Users/jenom/.vscode/.venv/poker-model3.sav'
model3 = pickle.load(open(filename, 'rb'))

filename = 'C:/Users/jenom/.vscode/.venv/poker-model4.sav'
...
import pandas as pd
cand_hands = pd.read_csv('C:/Users/jenom/.vscode/.venv/poker-hand-testing-1.csv')
...
imp = pygame.image.load("C:/Users/jenom/.vscode/.venv/cards.jpg")
...
flip_sound = pygame.mixer.Sound("C:/Users/jenom/.vscode/.venv/share/man/man1/flipcard.wav")
